...
ALTER TABLE  `collection_items` CHANGE `material_id` `course_id` INT(10) UNSIGNED NOT NULL; 
ALTER  TABLE `course_languages` CHANGE `material_id` `course_id` INT(10) UNSIGNED NOT NULL, DROP INDEX `course_id`, ADD KEY `course_id_idx` (`course_id`); 
