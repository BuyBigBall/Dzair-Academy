<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute right-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav" style="z-index:9"></i>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'course-material' ? 'active' : '' }}" href="{{ route('course-material') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'message' || Route::currentRouteName() == 'inbox' || Route::currentRouteName() == 'outbox' ? 'active' : '' }}" href="{{ route('message') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <a class="nav-link {{ Route::currentRouteName() == 'collection' ? 'active' : '' }}" href="{{ route('collection') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>{{translate('My Collections')}}</title>
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'my-courses' ? 'active' : '' }}" href="{{ route('my-courses') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-folder ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['my-courses']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">{{translate('My Courses')}}</span>
                </a>
            </li>
            @if( Auth::user()->role=='admin' )
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'site-pages' ? 'active' : '' }}" href="{{ route('site-pages') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-cog ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['site-pages']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">{{translate('Pages')}}</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user-management' ? 'active' : '' }}" href="{{ route('user-management') }}">
                    ...
                    <span class="nav-link-text ms-1">{{translate('User Management')}}</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'university-manage' ? 'active' : '' }}" href="{{ route('university-manage') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['university-manage']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">{{translate('University Manage')}}</span>
                </a>
            </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user-profile' ? 'active' : '' }}" href="{{ route('user-profile') }}">
                    ...
                    <span class="nav-link-text ms-1">{{translate('User Profile')}}</span>
                </a>
            </li>
        </ul>
    </div>
