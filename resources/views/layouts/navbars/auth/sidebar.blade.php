    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'search' ? 'active' : '' }}" href="{{ route('search') }}">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'course-management' ? 'active' : '' }}" href="{{ route('course-management') }}">
                    ...
                    <span class="nav-link-text ms-1">{{__('pages.ManageCourses')}}</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'message' || Route::currentRouteName() == 'inbox' || Route::currentRouteName() == 'outbox' ? 'active' : '' }}" href="{{ route('message') }}">
                    ...
                    <span class="nav-link-text ms-1">{{translate('Message Manage')}}</span>                
                </a>
            ...
            <!-- <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Collection</h6>
            </li> -->
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tables' ? 'active' : '' }}" href="{{ route('tables') }}">
                    ...
                    <span class="nav-link-text ms-1">{{__('pages.CreateCollection')}}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'billing' ? 'active' : '' }}" href="{{ route('billing') }}">
                    ...
                    <span class="nav-link-text ms-1">{{__('pages.ManageCollections')}}</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'profile' ? 'active' : '' }}" href="{{ route('profile') }}">
                    ...
                    <span class="nav-link-text ms-1">{{__('pages.Inbox')}}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'profile' ? 'active' : '' }}" href="{{ route('profile') }}">
                    ...
                    <span class="nav-link-text ms-1">{{__('pages.Settings')}}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user-profile' ? 'active' : '' }}" href="{{ route('user-profile') }}">
                    ...
                    <span class="nav-link-text ms-1">{{__('pages.Profile')}}</span>
                </a>
            </li>
