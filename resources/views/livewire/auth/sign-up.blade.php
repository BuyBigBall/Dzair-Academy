                          ...
                          <form wire:submit.prevent="register" action="#" method="POST" role="form text-left">
                              ...
                              <div class="form-check form-check-info text-left">
                                  ...
                                  <label class="form-check-label" for="flexCheckDefault">
                                      {{ __('I agree the') }} <a href="privacy" target="_blank" class="text-dark font-weight-bolder">{{ __('Terms
                                          and
                                          Conditions') }}</a>
                                  </label>
                              </div>
                              ...
                              <p class="text-sm mt-3 mb-0">{{ __('Already have an account? ') }}<a href="{{ route('login') }}" class="text-dark font-weight-bolder">{{ __('Sign in') }}</a>
                              </p>
                          </form>
