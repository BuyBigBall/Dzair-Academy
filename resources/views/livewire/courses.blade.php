                ...
                <div class="row">
                  <div class="col-md-9 col-sm-6">                            
                            ...
                            <div class="row mt-3">
                                <div class="col-md-9">
                                    <div class="form-group d-sm-flex align-items-center">
                                        <label class="custom-control-label me-3 w-25" for="description">Description: </label>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-9">
                                    <div class="form-group d-sm-flex align-items-center">
                                        <label for="formFile" class="custom-control-label me-3 w-25">File:</label>
                                        <input class="form-control" type="file" wire:model="file" name="file"  id="formFile">
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-group d-sm-flex align-items-center">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-9">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" wire:model="protection" name="protection" 
                                                    value="" id="encrption">
                                        <label class="custom-control-label" for="encrption">Password protection </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    <button type="submit" class="btn bg-gradient-success  btn-lg w-100" >Upload</button>
                                </div>
                            </div>
                        </div>
