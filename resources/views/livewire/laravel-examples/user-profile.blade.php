            ...
            <div class="card-body pt-4 p-3">
                ...
                <form wire:submit.prevent="save" action="#" method="POST" role="form text-left">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('message') }}" class="btn btn-primary mt-4 mb-4">{{ translate('Send Message') }}</a>
                            &nbsp;
                        <a href="{{ route('collection') }}" class="btn btn-secondary mt-4 mb-4">{{ translate('Collections Manage') }}</a>
                    </div>
                </form>
