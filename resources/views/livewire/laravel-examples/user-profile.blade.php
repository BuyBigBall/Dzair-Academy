<div>
    <div class="container-fluid">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative bg-light">
                        <img src="../assets/img/bruce-mars.jpg" alt="..." class="w-100 border-radius-lg shadow-sm" id="output">
                        <a id="imgUpload" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
                            <input type="file" accept="image/*" name="image" id="file" onchange="loadFile(event)" style="display: none;">
                            <label for="file" class="m-0"><i class="fa fa-pen top-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Image"></i></label>
                        </a>
                    </div>
                </div>
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form wire:submit.prevent="save" action="#" method="POST" role="form text-left">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-success btn-md mt-4 mb-4">{{ 'Save Changes' }}</button>
                    </div>
                </form>
